...
class ProductoController extends Controller
{
     ...
     *
     * @Route("/", name="crud_producto_index")
     * @Method("GET")
     */
     ...
     *
     * @Route("/new", name="crud_producto_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('crud_producto_show', array('codigoProducto' => $producto->getCodigoproducto()));
        }
     ...
     *
     * @Route("/{codigoProducto}", name="crud_producto_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{codigoProducto}/edit", name="crud_producto_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Producto $producto)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('crud_producto_edit', array('codigoProducto' => $producto->getCodigoproducto()));
        }
     ...
     *
     * @Route("/{codigoProducto}", name="crud_producto_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Producto $producto)
    {
        ...
        return $this->redirectToRoute('crud_producto_index');
    }
    ...
    private function createDeleteForm(Producto $producto)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('crud_producto_delete', array('codigoProducto' => $producto->getCodigoproducto())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
